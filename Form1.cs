...
namespace Projeto_Cantina
{
    public partial class Form1 : Form
    {
        ...
        {
            listCardapio.Items.Add(new Produto("Pão de Queijo", 3.50m, false));
            listCardapio.Items.Add(new Produto("Coxinha", 5.00m, false));
            listCardapio.Items.Add(new Produto("Pastel de Carne", 6.00m, false));
            listCardapio.Items.Add(new Produto("Pastel de Queijo", 5.50m, false));
            listCardapio.Items.Add(new Produto("Suco Natural 300 ml", 4.00m, false));
            listCardapio.Items.Add(new Produto("Refrigerante Lata", 3.50m, false));
            listCardapio.Items.Add(new Produto("Hambúrguer Simples", 8.00m, true));
            listCardapio.Items.Add(new Produto("Hambúrguer Com Queijo", 9.00m, true));
            listCardapio.Items.Add(new Produto("X-Tudo", 12.00m, true));
            listCardapio.Items.Add(new Produto("Água Mineral", 2.50m, false));
        ...
        private void btnConcluir_Click(object sender, EventArgs e)
        {
            ...
            foreach (Produto produto in novoPedido.Produtos)
            {

                if (produto.chapa)
                {
                    novoPedido.status = Status.PREPARANDO;
                    break;
                }
                else
                {
                    novoPedido.status = Status.PRONTO;
                }
            }

            ClasseListaPedidos.Pedidos.Add(novoPedido);
        }
